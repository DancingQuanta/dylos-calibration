...
\begin{document}
\maketitle
This summary report shows the time series plots of two Dylos sensors, Dylos DC1700 and Dylos DC1100 for whole boxed experiment and for each particle sizes introduced into the box.
...
{\VAR{item}}
\end{center}
\input{\VAR{condition['twoplot']}}

\BLOCK{if loop.index % 2 == 0}
\\
\BLOCK{else}
&
\BLOCK{endif}
